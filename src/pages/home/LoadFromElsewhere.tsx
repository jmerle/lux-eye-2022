  ...
  return (
    <HomeCard title="Load from elsewhere">
      ...
      <Text mb="xs">
        Supported inputs:
        <List>
          <List.Item>Kaggle episode ids, like <a href="#" onClick={copyToInput}>45408676</a>.</List.Item>
          <List.Item>Kaggle leaderboard URLs, like <a href="#" onClick={copyToInput}>https://www.kaggle.com/competitions/lux-ai-2022-beta/leaderboard?dialog=episodes-episode-45408676</a>.</List.Item>
          <List.Item>URLs to JSON episode data, like <a href="#" onClick={copyToInput}>https://www.kaggleusercontent.com/episodes/45408676.json</a>.</List.Item>
        </List>
      </Text>
